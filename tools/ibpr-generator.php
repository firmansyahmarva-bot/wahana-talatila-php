...
<section class="main">
  <div class="container">
    ...
    <div class="cta-strip">
      ...
      <a class="wa-btn" href="https://wa.me/6281235036420?text=Halo%20Wahana%2C%20saya%20pakai%20IBPR%20Generator%20dan%20ingin%20tanya%20pelatihan%20K3" target="_blank" rel="noopener">📱 Tanya Pelatihan Ahli K3 Umum</a>
    </div>
  </div>
</section>
...
<a class="wa-float" href="https://wa.me/6281235036420" target="_blank" style="position:fixed;bottom:24px;right:24px;background:#25D366;width:52px;height:52px;border-radius:50%;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 14px rgba(37,211,102,.4);z-index:999">
