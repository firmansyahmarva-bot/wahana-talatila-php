...
<section style="background:linear-gradient(135deg,#0A2A5A 0%,#0A4A2E 70%,#0a3a4a 100%);color:#fff;padding:60px 20px 50px;">
  <div style="max-width:900px;margin:0 auto;">
    ...
    <a href="https://wa.me/6287759151278?text=Halo%2C+saya+ingin+info+pelatihan+teknologi+informasi+dan+digital+untuk+ASN%2Finstansi+kami+di+Yogyakarta."
...
<main style="max-width:960px;margin:0 auto;padding:40px 20px 60px;">
  ...
  <section style="background:linear-gradient(135deg,#0A2A5A,#0A4A2E);color:#fff;border-radius:12px;padding:40px;text-align:center;">
    ...
    <a href="https://wa.me/6287759151278?text=Halo%2C+saya+ingin+proposal+pelatihan+teknologi+informasi+dan+digital+untuk+instansi+kami.+Mohon+info+program+dan+harga."
       target="_blank" rel="noopener"
