...
<nav class="navbar" id="navbar">
  <div class="container nav-inner">
    ...
    <!-- Mobile search form with Search Icon + Input + Green "Cari" Button (matches screenshot 1) -->
    <form action="/pelatihan/" method="get" class="nav-search-form" id="navSearchMobile">
      <span class="nsf-icon" aria-hidden="true">
        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
      </span>
      <input type="search" name="q" class="nsf-input" placeholder="Cari pelatihan..." aria-label="Cari pelatihan" autocomplete="off" value="<?= e($_GET['q'] ?? '') ?>">
      <button type="submit" class="nsf-submit" aria-label="Cari">Cari</button>
    </form>
    ...
    <div class="nav-actions">
      <!-- PC Desktop Search Input (Matches Reference Screenshot 2) -->
      <form action="/pelatihan/" method="get" class="nav-search-pc">
        <input type="search" name="q" placeholder="Cari pelatihan..." aria-label="Cari pelatihan" autocomplete="off" value="<?= e($_GET['q'] ?? '') ?>">
