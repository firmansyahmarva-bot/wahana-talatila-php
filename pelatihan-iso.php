...
$meta_desc  = 'Pelatihan sertifikasi ISO 9001:2015, ISO 14001:2015, dan ISO 45001:2018 untuk Internal Auditor dan Lead Auditor. Diakui internasional. Yogyakarta & in-house. Hubungi: 0877-5915-1278.';
...
<section style="background:linear-gradient(135deg,#0A4A2E 0%,#1a6b42 100%);color:#fff;padding:60px 20px 50px;">
  <div style="max-width:900px;margin:0 auto;">
    ...
    <a href="https://wa.me/6287759151278?text=Halo%2C+saya+ingin+mendaftar+pelatihan+ISO+(9001%2F14001%2F45001).+Mohon+info+jadwal+dan+biaya."
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:20px;">
      ...
      <div style="background:#fff;border:1px solid #ddd;border-radius:8px;overflow:hidden;display:flex;flex-direction:column;">
        ...
        <div style="padding:0 16px 16px;">
          <a href="https://wa.me/6287759151278?text=<?php echo $wa_text; ?>"
             target="_blank" rel="noopener"
