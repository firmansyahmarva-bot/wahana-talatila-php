...
<div class="container pcat-filter-row">
  <div class="filter-bar" style="width:100%;max-width:780px;">
    <div class="catalog-search-wrap">
      ...
      <input type="text" id="catalog-search" placeholder="Cari nama program pelatihan..." oninput="filterCatalog()">
    </div>
...
<a href="<?= wa_url('Halo, saya ingin info program pelatihan K3.') ?>" class="wa-float" target="_blank" rel="noopener" aria-label="WhatsApp">
