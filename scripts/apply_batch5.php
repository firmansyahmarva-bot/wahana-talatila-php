<?php
/**
 * scripts/apply_batch5.php
 * Automated updater for Batch 5 (Courses 41 - 50)
 * 
 * STRICT INVARIANT: Slugs are 100% IMMUTABLE.
 * Flow: Reads batch5_content_data.php -> Sends authenticated update -> Verifies response.
 */

$batchDataFile = __DIR__ . '/batch5_content_data.php';
...
// 10 Whitelisted Slugs for Batch 5 — NEVER MODIFY
$expectedSlugs = [
    'pelatihan-authorized-gas-tester-agt-online',
    'pelatihan-petugas-k3-sertifikasi-bnsp',
    'pelatihan-paramedis-k3-muda-sertifikasi-bnsp',
    ...
    'pelatihan-teknisi-ruang-terbatas-sertifikasi-bnsp',
...
echo "══════════════════════════════════════════════════════════════════════\n";
echo "BATCH 5 CONTENT UPDATE RUNNER (COURSES 41 - 50)\n";
...
foreach ($courses as $slug => $payload) {
    ...
    $updateData = [
        ...
        'actor'        => 'batch5_seo_intent_rewrite'
    ];
    ...
    curl_setopt_array($ch, [
        ...
        CURLOPT_HTTPHEADER     => [
            ...
            'X-API-Key: ' . $apiKey,
            'User-Agent: WahanaAgent/1.0 (Batch5-Updater)'
        ],
        CURLOPT_TIMEOUT        => 30,
...
echo "══════════════════════════════════════════════════════════════════════\n";
echo "BATCH 5 UPDATE COMPLETE SUMMARY:\n";
