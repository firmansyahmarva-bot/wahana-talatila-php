<?php
/**
 * scripts/apply_batch6.php
 * Automated updater for Batch 6 (Courses 51 - 60)
 * 
 * STRICT INVARIANT: Slugs are 100% IMMUTABLE.
 * Flow: Reads batch6_content_data.php -> Sends authenticated update -> Verifies response.
 */

$batchDataFile = __DIR__ . '/batch6_content_data.php';
...
// 10 Whitelisted Slugs for Batch 6 — NEVER MODIFY
$expectedSlugs = [
    ...
    'pelatihan-ahli-utama-ruang-terbatas-sertifikasi-bnsp',
    'pelatihan-hazard-dan-operability-studies-hazops-sertifikasi-bnsp',
    'pelatihan-ahli-higiene-industri-madya-sertifikasi-bnsp',
    'pelatihan-ahli-higiene-industri-utama-sertifikasi-bnsp',
...
echo "══════════════════════════════════════════════════════════════════════\n";
echo "BATCH 6 CONTENT UPDATE RUNNER (COURSES 51 - 60)\n";
...
foreach ($courses as $slug => $payload) {
    ...
    $updateData = [
        ...
        'actor'        => 'batch6_seo_intent_rewrite'
    ];
    ...
    curl_setopt_array($ch, [
        ...
        CURLOPT_HTTPHEADER     => [
            ...
            'X-API-Key: ' . $apiKey,
            'User-Agent: WahanaAgent/1.0 (Batch6-Updater)'
        ],
        CURLOPT_TIMEOUT        => 30,
...
echo "══════════════════════════════════════════════════════════════════════\n";
echo "BATCH 6 UPDATE COMPLETE SUMMARY:\n";
